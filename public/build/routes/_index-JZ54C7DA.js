...
var import_react_slick = __toESM(require_lib(), 1);
...
function Index() {
    ...
    async function fetchHomepageData() {
      try {
        ...
        if (data?.data?.length) {
          ...
          const bannerImageUrl = homepage.banner_image?.formats?.large?.url ? `http://localhost:1337${homepage.banner_image.formats.large.url}` : homepage.banner_image?.url ? `http://localhost:1337${homepage.banner_image.url}` : "";
          let descriptionText = "";
          if (Array.isArray(homepage.description)) {
            homepage.description.forEach((block) => {
          ...
          setError("Aucune donn\xE9e trouv\xE9e");
        }
      } catch (err) {
        console.error(err);
        setError("Erreur lors du chargement des donn\xE9es");
      }
    }
    fetchHomepageData();
  }, []);
  (0, import_react.useEffect)(() => {
    async function fetchRealisations() {
      try {
        ...
        const data = await response.json();
        if (data?.data) {
          const realisationsData = data.data.map((item) => ({
            id: item.id,
            title: item.Titre || "Titre indisponible",
            image_url: item.Images?.[0]?.url ? `http://localhost:1337${item.Images[0].url}` : void 0,
  ...
  (0, import_react.useEffect)(() => {
    async function fetchActualites() {
      try {
        const response = await fetch("http://localhost:1337/api/actualites?populate=*&sort[0]=publishedAt:desc&pagination[limit]=1");
        if (!response.ok)
          throw new Error(`HTTP ${response.status}`);
        const data = await response.json();
        if (data?.data) {
  ...
  if (loading)
    return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { children: "Chargement..." }, void 0, false, {
      fileName: "app/routes/_index.tsx",
      lineNumber: 124,
      columnNumber: 23
    }, this);
  if (error)
    return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-red-500", children: error }, void 0, false, {
      fileName: "app/routes/_index.tsx",
      lineNumber: 125,
      columnNumber: 21
    }, this);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("header", { className: "banner relative bg-cover bg-center h-[100vh] flex flex-col justify-end text-white p-8", style: {
      backgroundImage: `url(${homepageData?.image_url})`
    }, children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "banner-content text-center z-10 flex flex-col items-center justify-end pb-16", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: "font-basecoat text-5xl font-bold drop-shadow-lg uppercase", children: "Les trousses" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 154,
          columnNumber: 11
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/realisations", className: "font-basecoat btn bg-yellow-400 text-black px-6 py-3 rounded transform transition duration-500 hover:scale-105 font-semibold", children: "Foncez !" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 156,
          columnNumber: 13
        }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "absolute inset-0 bg-black opacity-50 z-0" }, void 0, false, {
        fileName: "app/routes/_index.tsx",
        lineNumber: 162,
        columnNumber: 9
      }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "banner-content mt-12 text-center z-10 flex flex-col items-center justify-end", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "font-basecoat text-xl drop-shadow-lg max-w-[750px]", children: homepageData?.description }, void 0, false, {
      fileName: "app/routes/_index.tsx",
      lineNumber: 167,
      columnNumber: 9
    }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "relative z-10 mt-12 text-center -mb-[var(--margin-mobile)] lg:-mb-[var(--margin-desktop)]", style: {
      "--margin-desktop": "75px",
      "--margin-mobile": "20px"
    }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { className: "font-ogg font-light uppercase text-[35px] md:text-[40px] lg:text-[60px] text-black leading-tight tracking-[5px]", children: "\xC0 ne pas manquer" }, void 0, false, {
      fileName: "app/routes/_index.tsx",
      lineNumber: 176,
      columnNumber: 9
    }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "actualites py-16 bg-yellow-100 max-w-7xl mx-auto px-4 rounded-lg shadow-md mt-12", children: actualites.length > 0 ? actualites.map((actu) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-col md:flex-row items-center gap-8 mb-12", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "md:w-1/2", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { className: "font-basecoat text-3xl font-semibold text-black mb-4", children: actu.title }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 184,
          columnNumber: 17
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "font-basecoat text-gray-800 text-lg whitespace-pre-line", children: actu.content }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 185,
          columnNumber: 17
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: `/actualites/`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { type: "button", className: "font-basecoat uppercase py-2.5 px-5 me-2 mb-2 text-sm font-medium text-indigo-600 mt-2 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100", children: "Toutes les actualit\xE9s" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 187,
          columnNumber: 19
        }, this) }, void 0, false, {
      ...
      actu.image_url && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "md:w-1/2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: actu.image_url, alt: actu.title, className: "w-full h-64 object-cover rounded-md shadow-md" }, void 0, false, {
        fileName: "app/routes/_index.tsx",
        lineNumber: 194,
        columnNumber: 19
      }, this) }, void 0, false, {
      ...
      lineNumber: 182,
      columnNumber: 57
    }, this)) : /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-center text-gray-600", children: "Aucune actualit\xE9 disponible." }, void 0, false, {
      fileName: "app/routes/_index.tsx",
      lineNumber: 197,
      columnNumber: 23
    }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "products py-16 bg-white max-w-7xl mx-auto px-4 relative z-10", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "relative z-10 mt-12 text-center -mb-[var(--margin-mobile)] lg:-mb-[var(--margin-desktop)]", style: {
        "--margin-desktop": "75px",
        "--margin-mobile": "20px"
      }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { className: "font-ogg font-light uppercase text-[28px] sm:text-[35px] md:text-[40px] lg:text-[60px] text-black leading-tight tracking-[3px] sm:tracking-[4px] md:tracking-[5px]", children: "Laisserez-vous tenter ?" }, void 0, false, {
        fileName: "app/routes/_index.tsx",
        lineNumber: 207,
        columnNumber: 11
      }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react_slick.default, { ...sliderSettings, className: "mt-8 relative z-0", children: realisations.map((realisation) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "p-2 sm:p-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: `/realisations/${realisation.id}`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-gray-200 p-4 sm:p-6 rounded-lg shadow-lg text-center hover:shadow-xl transition", children: [
        realisation.image_url ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: realisation.image_url, alt: realisation.title, className: "w-full h-40 sm:h-48 md:h-52 object-cover rounded-md" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 216,
          columnNumber: 44
        }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full h-40 sm:h-48 md:h-52 bg-gray-300 flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-gray-500", children: "Aucune image" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 217,
          columnNumber: 23
        }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h3", { className: "font-basecoat mt-3 sm:mt-4 text-lg sm:text-xl font-semibold", children: realisation.title }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 219,
          columnNumber: 19
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "font-basecoat mt-1 sm:mt-2 text-gray-700 text-sm sm:text-base", children: realisation.description }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 220,
          columnNumber: 19
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "font-basecoat mt-1 sm:mt-2 text-gray-700 font-medium", children: [
          realisation.prix,
          " \u20AC"
        ] }, void 0, true, {
          fileName: "app/routes/_index.tsx",
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { type: "button", className: "font-basecoat uppercase py-2 px-4 sm:py-2.5 sm:px-5 mt-2 text-sm sm:text-base font-medium text-indigo-600 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 transition", children: "Voir plus" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 222,
          columnNumber: 19
        }, this)
...
_s(Index, "QKhm2szAF5sSW0kc2k9w2smCidw=");
_c = Index;
var _c;
$RefreshReg$(_c, "Index");
...
classnames/index.js:
  ...
  *)
*/
//# sourceMappingURL=/build/routes/_index-JZ54C7DA.js.map

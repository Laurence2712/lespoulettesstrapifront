...
export default function MentionsLegales() {
  ...
  return (
    <div
      ref={scrollRef}
      className="py-6 sm:py-8 md:py-[60px] px-4 sm:px-6 md:px-12 max-w-[1440px] mx-auto mt-16 sm:mt-20 md:mt-24"
    >
      {/* Breadcrumb */}
      <nav className="anim-fade-up font-basecoat mb-6 sm:mb-8 text-xs sm:text-sm">
        ...
        <span className="text-gray-600 dark:text-gray-400 dark:text-gray-500">{t('legal.breadcrumb_text')}</span>
      </nav>
      ...
      <div className="max-w-3xl space-y-10 font-basecoat text-gray-700 dark:text-gray-300 text-sm sm:text-base leading-relaxed">

        {/* 1. Éditeur */}
        <section className="anim-fade-up" data-delay="0.2">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 uppercase mb-4">1. Éditeur du site</h2>
          <p>
        ...
        <section className="anim-fade-up" data-delay="0.25">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 uppercase mb-4">2. Hébergement</h2>
          <p>
        ...
        <section className="anim-fade-up" data-delay="0.3">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 uppercase mb-4">3. Conditions générales de vente</h2>

          <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">3.1 Produits</h3>
          <p className="mb-4">
          ...
          <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">3.2 Prix</h3>
          <p className="mb-4">
          ...
          <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">3.3 Commande</h3>
          <p className="mb-4">
          ...
          <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">3.4 Paiement</h3>
          <p className="mb-4">
          ...
          <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">3.5 Livraison</h3>
          <p className="mb-4">
          ...
          <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">3.6 Rétractation et retours</h3>
          <p className="mb-4">
        ...
        <section className="anim-fade-up" data-delay="0.35">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 uppercase mb-4">4. Données personnelles (RGPD)</h2>
          <p className="mb-4">
        ...
        <section className="anim-fade-up" data-delay="0.4">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 uppercase mb-4">5. Propriété intellectuelle</h2>
          <p>
        ...
        <section className="anim-fade-up" data-delay="0.45">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 uppercase mb-4">6. Litiges</h2>
          <p className="mb-4">
        ...
        <p className="anim-fade-up text-xs text-gray-400 dark:text-gray-500" data-delay="0.5">

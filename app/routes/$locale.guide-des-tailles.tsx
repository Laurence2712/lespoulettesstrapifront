    ...
    <div ref={scrollRef} className="overflow-x-hidden">
      ...
      <header className="bg-beige dark:bg-gray-900 pt-28 sm:pt-32 md:pt-40 pb-14 sm:pb-18 md:pb-24">
        ...
        <div className="max-w-3xl">
          <h1 className="anim-fade-up font-basecoat text-3xl sm:text-4xl md:text-[56px] font-bold uppercase text-gray-900 dark:text-gray-100 leading-tight">
            {t('sizes.title')}
          </h1>
          ...
          <p className="anim-fade-up font-basecoat text-lg sm:text-xl text-gray-700 dark:text-gray-300 leading-relaxed" data-delay="0.2">
      ...
      {/* ── Note dimensions ── */}
      <div className="px-6 sm:px-10 md:px-16 lg:px-24 py-6 sm:py-8">
      ...
      {SIZES.map((cat) => (
        <section key={cat.category} className="px-6 sm:px-10 md:px-16 lg:px-24 py-10 sm:py-12">
            ...
            <table className="w-full font-basecoat text-sm sm:text-base">
              ...
              <tbody className="divide-y divide-gray-50">
                {cat.items.map((item, i) => (
                  <tr key={i} className="bg-white dark:bg-gray-900 hover:bg-white dark:bg-gray-900 transition-colors">
                    <td className={`py-4 px-5 font-semibold text-gray-900 dark:text-gray-100 border-l-4 ${cat.color}`}>{item.name}</td>
                    <td className="py-4 px-5 text-gray-600 dark:text-gray-400 dark:text-gray-500">{item.dims}</td>
                    <td className="py-4 px-5 text-gray-500 dark:text-gray-400 dark:text-gray-500 hidden sm:table-cell">{item.ideal}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="sm:hidden mt-3 space-y-2">
            {cat.items.map((item, i) => (
              <p key={i} className="font-basecoat text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">
                <span className="font-semibold text-gray-700 dark:text-gray-300">{item.name} :</span> {item.ideal}
              </p>
            ))}
          </div>
        </section>
      ...
      <section className="bg-beige dark:bg-gray-900 py-14 sm:py-18">
        ...
        <div className="anim-stagger grid grid-cols-1 sm:grid-cols-3 gap-5" data-stagger="0.1">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm">
            <h3 className="font-basecoat font-bold uppercase text-gray-900 dark:text-gray-100 mb-3 text-base">Tissu extérieur</h3>
            <p className="font-basecoat text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 leading-relaxed">Wax africain 100% coton de haute qualité, tissé et imprimé à la main. Résistant, lavable, aux motifs uniques.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm">
            <h3 className="font-basecoat font-bold uppercase text-gray-900 dark:text-gray-100 mb-3 text-base">Doublure intérieure</h3>
            <p className="font-basecoat text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 leading-relaxed">Coton doux coordonné ou contrasté — protège vos affaires et facilite la recherche à l'intérieur.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm">
            <h3 className="font-basecoat font-bold uppercase text-gray-900 dark:text-gray-100 mb-3 text-base">Fermetures</h3>
            <p className="font-basecoat text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 leading-relaxed">Fermetures à glissière ou liens en tissu, selon le modèle. Solides et pratiques au quotidien.</p>
          </div>
        </div>
        </div>
      </section>
      ...
      <section className="px-6 sm:px-10 md:px-16 lg:px-24 py-14 sm:py-18">
        ...
        <div className="anim-stagger grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5" data-stagger="0.1">
          {CARE.map((tip) => (
            <div key={tip.title} className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
              <div className="text-3xl mb-3">{tip.icon}</div>
              <h3 className="font-basecoat font-bold uppercase text-gray-900 dark:text-gray-100 mb-2 text-base">{tip.title}</h3>
              <p className="font-basecoat text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 leading-relaxed">{tip.text}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-white dark:bg-gray-900 py-12 sm:py-14 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to={lp("/realisations")}
            className="font-basecoat border-2 border-benin-jaune text-gray-900 dark:text-gray-100 hover:bg-benin-jaune hover:text-black dark:text-gray-100 px-10 py-4 rounded-xl font-bold uppercase tracking-wider transition-all duration-200 hover:scale-[1.02] hover:shadow-lg"
          >
            {t('sizes.cta_shop')}
          </Link>
          <a
            ...
            className="font-basecoat border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-benin-vert hover:text-benin-vert px-10 py-4 rounded-xl font-bold uppercase tracking-wider transition-all duration-200 hover:scale-[1.02]"
          >

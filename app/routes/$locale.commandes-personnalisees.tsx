      ...
      <section className="bg-black py-14 sm:py-18 md:py-24 text-center">
        <div className="px-6 sm:px-10 md:px-16 lg:px-24">
          ...
          <div className="anim-fade-up flex flex-col sm:flex-row gap-4 justify-center" data-delay="0.2">
            ...
            <Link
              to={lp("/contact")}
              className="font-basecoat bg-benin-jaune text-black hover:bg-black hover:text-benin-jaune px-4 py-4 rounded-lg text-xs font-bold uppercase tracking-widest transition-all duration-300 inline-flex items-center gap-2"
            >
              {t('custom.contact_form_cta')}

      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
        ...
        <div className="anim-fade-left flex flex-col gap-5" data-delay="0.3">
          ...
          <a
            ...
            className="group flex items-center gap-5 p-5 sm:p-6 rounded-2xl border border-gray-200 dark:border-gray-700 hover:border-benin-jaune/40 bg-white dark:bg-gray-900 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
          >
            <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-white dark:bg-gray-900 group-hover:bg-benin-jaune/10 flex items-center justify-center transition-colors">
              <svg className="w-7 h-7 text-black dark:text-gray-100 group-hover:text-benin-jaune transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <p className="font-basecoat text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm sm:text-base">+229 01 62 00 75 80</p>
            </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-5 p-5 sm:p-6 rounded-2xl border border-gray-200 dark:border-gray-700 hover:border-benin-jaune/20 bg-white dark:bg-gray-900 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
          >
            <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-white dark:bg-gray-900 group-hover:bg-benin-jaune/10 flex items-center justify-center transition-colors">
              <svg className="w-7 h-7 text-black dark:text-gray-100 group-hover:text-benin-jaune transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <p className="font-basecoat text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm sm:text-base">Les Poulettes Couture</p>
            </div>
            <svg className="w-5 h-5 text-gray-300 group-hover:text-benin-jaune ml-auto transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          ...
          >
            ...
            <div>
              <p className="font-basecoat text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm sm:text-base">@lespoulettes.benin</p>
            </div>
            <svg className="w-5 h-5 text-gray-300 group-hover:text-benin-jaune ml-auto transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>

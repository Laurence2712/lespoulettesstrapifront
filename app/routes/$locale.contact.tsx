    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
        ...
        <div className="anim-fade-left flex flex-col gap-5" data-delay="0.3">
          ...
          >
            <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-white group-hover:bg-benin-jaune/10 flex items-center justify-center transition-colors">
              <svg className="w-7 h-7 text-black group-hover:text-benin-jaune transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-5 p-5 sm:p-6 rounded-2xl border border-gray-200 hover:border-benin-jaune/20 bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
          >
            <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-white group-hover:bg-benin-jaune/10 flex items-center justify-center transition-colors">
              <svg className="w-7 h-7 text-black group-hover:text-benin-jaune transition-colors" fill="currentColor" viewBox="0 0 24 24">

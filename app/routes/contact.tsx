      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-start md:items-center">
        ...
        <div className="order-1">
          ...
          >
            ...
            <button
              type="submit"
              className="font-basecoat w-full sm:w-auto bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg sm:rounded-xl transition transform hover:-translate-y-1 active:scale-95 text-sm sm:text-base"
            >
              Envoyer le message
            </button>
          </motion.form>

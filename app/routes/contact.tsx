      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
        ...
        <div className="anim-fade-right" data-delay="0.2">
          <Form method="post" className="space-y-5">
            ...
            <button
              ...
              className="font-basecoat w-full border-2 border-benin-jaune text-gray-900 hover:bg-benin-jaune hover:text-black font-bold uppercase tracking-wider px-8 py-4 rounded-xl transition-all duration-200 transform hover:scale-[1.02] hover:shadow-lg text-sm sm:text-base disabled:opacity-60 disabled:cursor-not-allowed disabled:scale-100"
            >
              {isSubmitting ? "Envoi en cours..." : "Envoyer"}
            </button>

            {actionData?.success && (
              <div className="bg-benin-vert/10 border border-benin-vert/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-benin-vert flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                  </svg>
                  <p className="font-basecoat text-benin-vert font-semibold text-sm">
        ...
        <div className="anim-fade-left flex flex-col gap-5" data-delay="0.3">
          ...
          <a
            ...
            className="group flex items-center gap-5 p-5 sm:p-6 rounded-2xl border border-gray-200 hover:border-benin-vert bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
          >
            <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-benin-vert/10 group-hover:bg-benin-vert/15 flex items-center justify-center transition-colors">
              <svg className="w-7 h-7 text-benin-vert" fill="currentColor" viewBox="0 0 24 24">
            ...
            <svg className="w-5 h-5 text-gray-300 group-hover:text-benin-vert ml-auto transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            className="group flex items-center gap-5 p-5 sm:p-6 rounded-2xl border border-gray-200 hover:border-benin-jaune bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
          >
            <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-benin-jaune/10 group-hover:bg-benin-jaune/15 flex items-center justify-center transition-colors">
              <svg className="w-7 h-7 text-benin-jaune" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
            ...
            <svg className="w-5 h-5 text-gray-300 group-hover:text-benin-jaune ml-auto transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          </a>

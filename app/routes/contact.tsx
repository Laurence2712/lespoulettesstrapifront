      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
        ...
        <div className="anim-fade-right" data-delay="0.2">
          <Form method="post" className="space-y-5">
            ...
            <button
              ...
              className="font-basecoat w-full bg-benin-jaune hover:bg-benin-jaune/90 text-black font-bold uppercase tracking-wider px-8 py-4 rounded-xl transition-all duration-200 transform hover:scale-[1.02] hover:shadow-lg text-sm sm:text-base disabled:opacity-60 disabled:cursor-not-allowed disabled:scale-100"
            >
        ...
        <div className="anim-fade-left flex flex-col gap-5" data-delay="0.3">
          ...
          <a
            ...
            className="group flex items-center gap-5 p-5 sm:p-6 rounded-2xl border border-gray-200 hover:border-benin-jaune/40 bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
          >
            <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-gray-50 group-hover:bg-benin-jaune/5 flex items-center justify-center transition-colors">
              <svg className="w-7 h-7 text-benin-jaune" fill="currentColor" viewBox="0 0 24 24">

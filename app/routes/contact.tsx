      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
          ...
          <Form method="post" className="space-y-5">
            <div>
              ...
              <input
                ...
                required
                className="font-basecoat w-full rounded-xl border border-gray-200 px-4 py-3 text-sm sm:text-base focus:ring-2 focus:ring-wax-red focus:border-wax-red outline-none transition bg-white"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                required
                className="font-basecoat w-full rounded-xl border border-gray-200 px-4 py-3 text-sm sm:text-base focus:ring-2 focus:ring-wax-red focus:border-wax-red outline-none transition resize-none bg-white"
              ></textarea>
            </div>
            ...
            <button
              ...
              className="font-basecoat w-full bg-wax-red hover:bg-wax-red/90 text-white font-bold uppercase tracking-wider px-8 py-4 rounded-xl transition-all duration-200 transform hover:scale-[1.02] hover:shadow-lg text-sm sm:text-base disabled:opacity-60 disabled:cursor-not-allowed disabled:scale-100"
            >
            ...
            {actionData?.success && (
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-wax-red flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                  </svg>
                  <p className="font-basecoat text-wax-red font-semibold text-sm">
        ...
        <div className="anim-fade-left flex flex-col gap-5" data-delay="0.3">
          ...
          <a
            ...
            className="group flex items-center gap-5 p-5 sm:p-6 rounded-2xl border border-gray-200 hover:border-wax-red/40 bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
          >
            <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-gray-50 group-hover:bg-wax-red/5 flex items-center justify-center transition-colors">
              <svg className="w-7 h-7 text-wax-red" fill="currentColor" viewBox="0 0 24 24">
            ...
            <svg className="w-5 h-5 text-gray-300 group-hover:text-wax-red ml-auto transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-gray-50 group-hover:bg-wax-red/5 flex items-center justify-center transition-colors">
              <svg className="w-7 h-7 text-wax-red" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>

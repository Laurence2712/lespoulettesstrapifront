...
const INPUT_CLASS = "font-basecoat w-full rounded-xl border border-gray-200 dark:border-gray-700 px-4 py-3 text-sm sm:text-base focus:ring-2 focus:ring-benin-jaune focus:border-benin-jaune outline-none transition bg-white dark:bg-gray-900";

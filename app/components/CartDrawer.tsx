                  ...
                  <div className="flex-1 flex flex-col min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-3">
                      ...
                      <button
                        ...
                        className="w-9 h-9 rounded-xl bg-benin-rouge/10 hover:bg-benin-rouge/15 flex items-center justify-center text-benin-rouge hover:text-benin-rouge transition"
                      >

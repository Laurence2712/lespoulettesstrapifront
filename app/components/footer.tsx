        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400 text-sm sm:text-base font-basecoat">
            <li>
              ...
              >
                <svg className="w-5 h-5 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
      ...
      <div className="border-t border-gray-800 mt-10 sm:mt-12 py-6 sm:py-8 px-4 sm:px-6 md:px-[60px] lg:px-[120px] flex flex-col sm:flex-row items-center justify-between gap-3 text-gray-500 text-sm font-basecoat">
        ...
        <p className="flex items-center gap-1.5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-white font-bold hover:text-benin-jaune transition"
          >
            Laurence Pirard
          </a>
          <span>✦</span>

...
export default function Footer() {
  ...
  return (
    <footer ref={scrollRef} className="bg-black text-white py-8 sm:py-10">
      <div className="anim-stagger px-4 sm:px-6 md:px-[60px] lg:px-[120px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8" data-stagger="0.1">
...
<p>
  ...
  >
    +229 01 62 00 75 80
      ...
      {/* Ligne du bas */}
      <div className="anim-fade-up border-t border-gray-700 mt-8 sm:mt-10 pt-4 sm:pt-6 text-center text-gray-500 text-sm sm:text-base font-basecoat">

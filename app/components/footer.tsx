...
export default function Footer() {
  ...
  return (
    <footer className="bg-black text-white">
      <div className="px-4 sm:px-6 md:px-12 max-w-[1440px] mx-auto py-12 sm:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-x-8 sm:gap-y-12 lg:gap-12">
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400 dark:text-gray-500 text-sm sm:text-base font-basecoat">
            ...
            <li>
              <a href="https://wa.me/2290162007580" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-benin-jaune transition">
        ...
        <div>
          ...
          <div className="flex gap-4">
            ...
            <a href="https://www.instagram.com/lespoulettes.benin/" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-xl bg-gray-800 hover:bg-benin-jaune flex items-center justify-center transition-all duration-300 group" aria-label="Instagram">
              <svg className="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-black dark:text-gray-100 transition-colors" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-12 py-6 sm:py-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm font-basecoat">

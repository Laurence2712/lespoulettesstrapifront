      ...
      <div className="px-4 sm:px-6 md:px-[60px] lg:px-[120px] py-12 sm:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-x-8 sm:gap-y-12 lg:gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-400 font-basecoat text-sm sm:text-base">
            <li>
              <Link to="/qui-sommes-nous" className="hover:text-wax-red transition">
                Qui sommes-nous
              </Link>
            </li>
            <li>
              <Link to="/realisations" className="hover:text-wax-red transition">
                Boutique
              </Link>
            </li>
            <li>
              <Link to="/commandes-personnalisees" className="hover:text-wax-red transition">
                Commandes personnalisées
              </Link>
            </li>
            <li>
              <Link to="/guide-des-tailles" className="hover:text-wax-red transition">
                Guide des tailles & Entretien
              </Link>
            </li>
            <li>
              <Link to="/actualites" className="hover:text-wax-red transition">
                Actualités
              </Link>
            </li>
            <li>
              <Link to="/contact" className="hover:text-wax-red transition">
                Contact
              </Link>
            </li>
            <li>
              <Link to="/faq" className="hover:text-wax-red transition">
                FAQ
              </Link>
            </li>
            <li>
              <Link to="/mentions-legales" className="hover:text-wax-red transition">
        ...
        {/* Colonne 3 : Contact */}
        <div>
          <h3 className="text-base sm:text-lg font-bold mb-4 sm:mb-5 uppercase font-basecoat tracking-wider">Contact</h3>
          <ul className="space-y-4 text-gray-400 text-sm sm:text-base font-basecoat">
            <li>
              <a
                href="mailto:lespoulettes.benin@gmail.com"
                className="flex items-center gap-3 hover:text-wax-red transition"
              >
                <svg className="w-5 h-5 text-wax-red flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
            ...
            <li>
              <a
                ...
                className="flex items-center gap-3 hover:text-wax-red transition"
              >
                <svg className="w-5 h-5 text-wax-red flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          <h3 className="text-base sm:text-lg font-bold mb-4 sm:mb-5 uppercase font-basecoat tracking-wider">Suivez-nous</h3>
          <div className="flex gap-4">
            <a
              href="https://www.facebook.com/lespoulettescouture"
              target="_blank"
              rel="noopener noreferrer"
              className="w-11 h-11 rounded-xl bg-gray-800 hover:bg-wax-red flex items-center justify-center transition-all duration-300 group"
              aria-label="Facebook"
            >
      ...
      <div className="border-t border-gray-800 mt-10 sm:mt-12 py-6 sm:py-8 px-4 sm:px-6 md:px-[60px] lg:px-[120px] flex flex-col sm:flex-row items-center justify-between gap-3 text-gray-500 text-sm font-basecoat">
        ...
        <p className="flex items-center gap-1.5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-wax-red hover:text-wax-red/70 transition font-semibold"
          >
            Laurence Pirard
          </a>
          <span>✦</span>
